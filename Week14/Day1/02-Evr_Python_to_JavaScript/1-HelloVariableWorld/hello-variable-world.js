...
console.log(`You make ${dailyWage} dollar per day.`);
console.log("You make " + dailyWage + " dollar per day")
// Print out the weekly wage that was calculated
console.log(`You make ${weeklyWage} dollar per week.`);
// Using an IF statement to print out whether the users were satisfied
if(satisfied === true){
  console.log("You are satisfied with you pay")
}
else {
  console.log("You are not satisied")
}